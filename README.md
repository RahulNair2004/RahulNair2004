...
🎓 Computer Science Graduate passionate about building intelligent software that combines **Artificial Intelligence**, **Machine Learning**, **Data Science**, and **Software Engineering**.
...
|:---------|:------------|:-------------|:-----------|
| ⚖️ **AI Legal Document Assistant** | AI-powered legal assistant that answers questions from legal documents using Retrieval-Augmented Generation (RAG). | Llama 3 • LangChain • FAISS • FastAPI • PostgreSQL | 🔗 [Repository](https://github.com/RahulNair2004/legal-document-assistant) |
| 🛡️ **AI-Powered Intrusion Detection System** | Detects malicious network traffic using Machine Learning algorithms for cybersecurity applications. | Python • Scikit-Learn • Flask • Pandas | 🔗 [Repository](https://github.com/RahulNair2004/intrusion-detection-system) |
| 📜 **NLP-Based Poem Analyzer** | AI-powered poem analyzer capable of identifying themes, emotions, literary devices and sentiment. | Python • Transformers • spaCy • NLTK | 🔗 [Repository](https://github.com/RahulNair2004/poem-analyzer) |
...
| 🧠 **ML-Driven Query Optimization** | Research project applying Graph Neural Networks to predict optimal SQL execution plans. | PostgreSQL • PyTorch • NetworkX • GNN | 🔗 [Repository](https://github.com/RahulNair2004/graphqopt) |
...
<a href="mailto:rahul.nair0306@gmail.com">
